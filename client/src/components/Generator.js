...
export const Generator = () => {
  ...
  const getReceiver =  e => {
    ...
    axios.post("https://santa-api.becode.org/api/attendee/receiver", name)
      .then(res => {
        setReceiver(res.data[getRandomInt(res.data.length)])
          axios.put("https://santa-api.becode.org/api/attendee", {data: {receiver: receiver, user: name}})
            .then(res => console.log(res))
            .catch(err => console.log(err))
          axios.post("https://santa-api.becode.org/api/mail", {to: receiver.email, text: `You have draw ${receiver.firstname + " " + receiver.lastname}`})
            .then(res => console.log(res))
            .catch(err => console.log(err))
    })
    .catch(err => console.log(err))
